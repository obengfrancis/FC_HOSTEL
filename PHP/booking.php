...
p{
 ...
 samp:hover{
  ...
  <body style="background-color: #dddddd;">
    ...
    <span class="navbar-text " style="padding-right: 60px"><h4 style="color:#28a745;font-family:AR HERMANN;">FCTC HOTEL, AKYAWKROM</h4>
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
      <a class="nav-link"><h6 style="color: #28a745;"><i class="fa fa-book"></i>   RESTAURANT&BAR</h6></a>
      <ul class="btn btn-info" data-toggle="collapse" data-target="#demo">
        <a class="nav-link" href="restaurant.html"><h6 style="color: #ADff2f;">RESTAURANT</h6></a>
        <a class="nav-link" href="bar.html"><h6 style="color: #ADff2f;">BAR</h6></a>        
        </ul>
      ...
      <a class="nav-link" ><h6 style="color: #28a745;"><i class="fa fa-book"></i>  AMENITIES</h6></a>
        ...
        <a class="nav-link" href="audio-visual1.html"><h6 style="color: #ADff2f;">AUDIO-VISUAL HALL 1 $ 2</h6></a>
        <a class="nav-link" href="field.html"><h6 style="color: #ADff2f;">FIELD</h6></a>
        </ul>
      </li>
      <li class="nav-item">
        <div class="collapse navbar-collapse" id="collapse_target">
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
  <h4 style="background-image: url(img/room1.jpg); height: 300px; background-repeat:round;">    
  <marquee  style="padding:bottom 100px; color: #28a745; font-style: italic; font-family:segoe ui">Welcome to Forestry Commission Training Center Hotel, Akyawkrom-Ejisu: We treat you as Kings and Queens</marquee> 
  </h4>
  </div>
</div>
</div>
  ...
  <form action="summary.php" method="POST">
    ...
    <div class="form-group">
      ...
      <input type="Number"  name="Phone_Number" class="form-control"  placeholder="Enter your number" required>
    </div>
  </div>
    <br>
    ...
    <div class="form-group">
      ...
      <input type="Number"  name="Relative_Number" class="form-control"  placeholder="Enter  your relative number"  required>
    </div>
  </div>
  ...
  <div class="col-sm-4">
   ...
   <h5>
   <marquee direction="up" scrollamount="3"  height="500">
