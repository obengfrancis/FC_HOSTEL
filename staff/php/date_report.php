...
<body  onload="noBack();">
  ...
  <ul class="navbar-nav mr-auto" >      
      <li class="nav-itme active">
        <a class="nav-link" href="date_report.php"><h5>REPORT B/N DATE</h5></a>
      </li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <li class="nav-itme">
    ...
    <form class="form-inline" action="date_report.php" method="post" enctype="multipart/form-data">
...
<table class=" table table-hover table-responsive" border="2" style="border-color: #000000;">
  ...
  <tbody>
   ...
   $query = "SELECT * FROM booking WHERE  Check_Out_Date LIKE '$valueToSearch2' ORDER BY CustomerID DESC";
