...
<body  onload="noBack();">
  ...
  <ul class="navbar-nav mr-auto" >      
      <li class="nav-itme active">
        <a class="nav-link" href="customer_report.php"><h5>GROUP REPORT</h5></a>
      </li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <li class="nav-itme">
    ...
    <form class="form-inline" action="group_report.php" method="post" enctype="multipart/form-data">
       <input name="searchid" class="form-control" type="text" placeholder="DATE, yyyy-mm-dd " required>&nbsp;
...
<table class=" table table-hover table-responsive" border="2" style="border-color: #000000;">
  ...
  <tbody>
   ...
   $query = "SELECT * FROM booking where Check_In_Date = '$valueToSearch2' ORDER BY CustomerID DESC";
