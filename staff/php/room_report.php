...
<body  onload="noBack();">
  ...
  <ul class="navbar-nav mr-auto" >      
      <li class="nav-itme active">
        <a class="nav-link" href="room_report.php"><h5>ROOM REPORT</h5></a>
      </li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <li class="nav-itme">
    ...
    <form class="form-inline" action="room_report.php" method="post" enctype="multipart/form-data">
       <input name="searchid" class="form-control mr-sm-2" type="text" placeholder="Enter room_type " required>&nbsp;
       <button class="btn btn-success btn-sm" type="submit" name="search">SEARCH</button>&nbsp;
...
<h6>>>ROOM REPORT</h6>
<table class=" table table-hover table-responsive" border="2" style="border-color: #000000;">
          <thead>
    <th>CustomerID</th>
    <th>Full Name </th>
  ...
  <tbody>
   ...
   $query = "SELECT * FROM booking where room_type = '$valueToSearch2' ORDER BY CustomerID DESC";
